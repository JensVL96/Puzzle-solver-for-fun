...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52), (TOP_RX, TOP_RY + 52), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45), (TOP_RX, TOP_RY + 52 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45), (TOP_RX, TOP_RY + 52 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52), (TOP_RX, TOP_RY + 52 + 45 + 45 + 52), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52+ 45), (TOP_RX, TOP_RY + 52 + 45 + 45 + 52 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52 + 45 + 45), (TOP_RX, TOP_RY + 52 + 45 + 45 + 52 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52 + 45 + 45 + 52), (TOP_RX, TOP_RY + 52 + 45 + 45 + 52 + 45 + 45 + 52), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45 + 45), (TOP_RX, TOP_RY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45 + 45), (TOP_RX, TOP_RY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45 + 45), 7)
        # pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (TOP_RX, TOP_RY), 7)
        # pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (TOP_RX, TOP_RY), 7)
        # pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (TOP_RX, TOP_RY), 7)
        # pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (TOP_RX, TOP_RY), 7)
