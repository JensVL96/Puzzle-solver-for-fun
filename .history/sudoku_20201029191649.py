    ...
    def draw(self, screen, grid):
        for i in range (9):
            for j in range (9):
                if grid[i][j] != 0:
                    ...
                    screen.blit(text1, (i * self.dif + 15, j * self.dif + 15))
        ...
        for i in range(10):
            if i %3 == 0:
                ...
                thick = 1
            pg.draw.line(screen, BLACK, (0, i * self.dif), (500, i * self.dif), thick)
            pg.draw.line(screen, BLACK, (i * self.dif, 0), (i * self.dif, 500), thick)



    def draw_box(self, screen):
        pg.draw.rect(screen, BLACK, (  (SCREEN_WIDTH / 2) - (BORDER_SIZE / 2), 
                                            (SCREEN_HEIGHT / 2) - (BORDER_SIZE / 2), 
                                            BORDER_SIZE, 
                                            BORDER_SIZE))
        pg.draw.rect(screen, WHITE, (  (SCREEN_WIDTH / 2) - (BOX_SIZE / 2), 
...
class Main():
    ...
    def run(self):
        ...
        self.display = Display_board(self.screen)
