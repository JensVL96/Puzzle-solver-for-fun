...
class Display_board():
    ...
    def update(self, grid, row, col, blk):
        ...
        if row != (0, 0):
            ...
            self.screen.blit(text1, (TOP_LX + row[0] * BLOCK_SIZE + 15, TOP_LY + row[1] * BLOCK_SIZE + 10))
        ...
        if col != (0, 0):
            ...
            self.screen.blit(text1, (TOP_LX + col[0] * BLOCK_SIZE + 15, TOP_LY + col[1] * BLOCK_SIZE + 10))
        ...
        if blk != (0, 0):
            ...
            self.screen.blit(text1, (TOP_LX + blk[0] * BLOCK_SIZE + 15, TOP_LY + blk[1] * BLOCK_SIZE + 10))
