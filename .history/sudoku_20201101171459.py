        ...
        while 1:
            ...
            if val != 0:
                ...
                if valid(board, int(box_index_x), int(box_index_y), val) and board[int(box_index_x)][int(box_index_y)] != 0:
                    if type(board[int(box_index_x)][int(box_index_y)]) == int:
                        print(board[int(box_index_x)][int(box_index_y)], val)
                        candidates.append(board[int(box_index_x)][int(box_index_y)])
