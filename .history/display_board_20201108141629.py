...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        TLX = TOP_LX - indent[9] * BOX_INDENT
        TLY = TOP_LY - indent[9] * BOX_INDENT
        TRX = TOP_RX + indent[9] * BOX_INDENT
        TRY = TOP_RY + indent[9] * BOX_INDENT
        BLX = BOT_LX + indent[9] * BOX_INDENT
        BLY = BOT_LY + indent[9] * BOX_INDENT
        ...
        for i in range(NUM_LINES):
            ...
            pg.draw.line(self.screen, BLACK, (TLX, 
                                            TLY + i * BLOCK_SIZE + indent[i] * BOX_INDENT), 
                                            (TRX, 
                                            TRY + i * BLOCK_SIZE + indent[i] * BOX_INDENT), thick)
            pg.draw.line(self.screen, BLACK, (TLX + i * BLOCK_SIZE + indent[i] * BOX_INDENT, 
                                            TLY), 
                                            (BLX + i * BLOCK_SIZE + indent[i] * BOX_INDENT, 
                                            BLY), thick)
