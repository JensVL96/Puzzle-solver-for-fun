...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (BOT_LX, BOT_LY), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5, TOP_LY), (BOT_LX + 48.5, BOT_LY), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45, TOP_LY), (BOT_LX + 48.5 + 45, BOT_LY), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45, BOT_LY), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5, BOT_LY), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5+ 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45, BOT_LY), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45, BOT_LY), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5, BOT_LY), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45, BOT_LY), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45, BOT_LY), 7)
