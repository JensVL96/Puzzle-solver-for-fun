...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52), (TOP_RX + 7.5, TOP_RY + 52 + 45 + 45 + 52), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52+ 45), (TOP_RX + 7.5, TOP_RY + 52 + 45 + 45 + 52 + 45), 1)
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45), (TOP_RX + 7.5, TOP_RY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45), 1)
