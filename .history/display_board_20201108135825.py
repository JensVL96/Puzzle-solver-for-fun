...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        for i in range(NUM_LINES):
            ...
            pg.draw.line(self.screen, BLACK, (TOP_LX, 
                                            TOP_LY + i * BLOCK_SIZE + indent[i]), 
                                            (TOP_RX + indent[9], 
                                            TOP_RY + i * BLOCK_SIZE + indent[i]), thick)
            pg.draw.line(self.screen, BLACK, (TOP_LX + i * BLOCK_SIZE + indent[i], 
                                            TOP_LY), 
                                            (BOT_LX + i * BLOCK_SIZE + indent[i], 
                                            BOT_LY + indent[9]), thick)
    ...
    def find_cell(self, x, y):
        ...
        start_pos_x = TOP_LX + x * BLOCK_SIZE + indent[x] * 3.5
        ...
        start_pos_y = TOP_LY + y * BLOCK_SIZE + indent[y] * 3.5
