...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5), (TOP_RX + 21, TOP_RY + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45), (TOP_RX + 21, TOP_RY + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5+ 45), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45), (TOP_RX + 21, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45), 7)
