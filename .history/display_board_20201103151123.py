            ...
            for j in range (9):
                if grid[i][j] != 0:
                    if type(grid[i][j]) != int:
                        new_line = 1
                        iteration = 1
                        indent_h = CELL_SIZE / 3 + 9
                        indent_v = CELL_SIZE / 3 + 8
        ...
        for i in range(10):
            ...
            if i % 3 == 0:
                pg.draw.line(self.screen, BLACK, (TOP_LX, 
                                                TOP_LY + i * CELL_SIZE), 
                                                ((TOP_LX + BLOCK_SIZE), 
                                                (TOP_LY + BLOCK_SIZE) + i * CELL_SIZE), 1)
                pg.draw.line(self.screen, BLACK, (TOP_LX + i * CELL_SIZE, 
                                                TOP_LY), 
                                                (TOP_LX + BLOCK_SIZE + i * CELL_SIZE,
                                                TOP_LY + BLOCK_SIZE), 1)
