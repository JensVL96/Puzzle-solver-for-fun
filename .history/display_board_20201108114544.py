...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (TOP_RX, TOP_RY), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5, TOP_LY), (TOP_RX, TOP_RY + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5+ 45, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45, TOP_LY), (TOP_RX, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45), 7)
