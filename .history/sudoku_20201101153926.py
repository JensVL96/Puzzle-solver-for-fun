    ...
    def run(self):
        ...
        while 1:
            ...
            if blink:
                ...
                alpha = display.blink()
                print("start pos x: ", cell[0], "start pos y: ", cell[1], "end pos x: ", cell[2], "end pos y: ", cell[3])
                ...
                pg.draw.rect(rect, GREEN, cell)
                # self.screen.blit(rect, (start_pos_X, start_pos_y))
