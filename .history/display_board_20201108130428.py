...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 1 * 45 + 1 * 3.5), (TOP_RX + 21, TOP_RY + 45 * 1 + 3.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 2 * 45 + 1 * 3.5), (TOP_RX + 21, TOP_RY + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 3 * 45 + 2 * 3.5), (TOP_RX + 21, TOP_RY + 1 * 45 + 1 * 3.5), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 4 * 45 + 3 * 3.5), (TOP_RX + 21, TOP_RY + 1 * 45 + 1 * 3.5 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 5 * 45 + 3 * 3.5), (TOP_RX + 21, TOP_RY + 1 * 45 + 1 * 3.5 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 6 * 45 + 4 * 3.5), (TOP_RX + 21, TOP_RY + 1 * 45 + 1 * 3.5 + 1 * 45 + 1 * 3.5), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 7 * 45 + 5 * 3.5), (TOP_RX + 21, TOP_RY + 1 * 45 + 1 * 3.5 + 1 * 45 + 1 * 3.5 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 8 * 45 + 5 * 3.5), (TOP_RX + 21, TOP_RY + 1 * 45 + 1 * 3.5 + 1 * 45 + 1 * 3.5 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 9 * 45 + 6 * 3.5), (TOP_RX + 21, TOP_RY + 52 + 45 + 45 + 52 + 45 + 45 + 52 + 45 + 45), 7)
