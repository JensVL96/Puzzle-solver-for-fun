...
class Display_board():
    ...
    def draw(self, grid):
        ...
        start_pos_x = (SCREEN_WIDTH / 2) - (BORDER_SIZE / 2)
        start_pos_y = (SCREEN_HEIGHT / 2) - (BORDER_SIZE / 2)
        end_pos_x = (SCREEN_WIDTH / 2) + (BORDER_SIZE / 2)
        end_pos_y = (SCREEN_HEIGHT / 2) - (BORDER_SIZE / 2)

        print("\nstart pos: (%d, %d)", start_pos_x, start_pos_y)
        print("end pos: (%d, %d)\n", end_pos_x, end_pos_y)
        ...
        for i in range(10):
            if i %3 == 0:
                ...
                thick = 1
            pg.draw.line(self.screen, BLACK, (start_pos_x, 
                                            start_pos_y + i * self.dif), 
                                            (end_pos_x, 
                                            end_pos_y + i * self.dif), thick)
            pg.draw.line(self.screen, BLACK, (start_pos_x + i * self.dif, 
                                            start_pos_y), 
                                            (end_pos_x + i * self.dif, 
                                            end_pos_y), thick)
