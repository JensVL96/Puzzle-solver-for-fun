...
class Display_board():
    ...
    def draw(self, grid, cell):
        ...
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (TOP_RX + 7.5, TOP_RY), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5), (TOP_RX + 7.5, TOP_RY + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45), (TOP_RX + 7.5, TOP_RY + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5+ 45), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45), (TOP_RX + 7.5, TOP_RY + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45), 7)
        
        pg.draw.line(self.screen, BLACK, (TOP_LX, TOP_LY), (BOT_LX, BOT_LY + 7.5), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5, TOP_LY), (BOT_LX + 48.5, BOT_LY + 7.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45, TOP_LY), (BOT_LX + 48.5 + 45, BOT_LY + 7.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45, BOT_LY + 7.5), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5, BOT_LY + 7.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5+ 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45, BOT_LY + 7.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45, BOT_LY + 7.5), 7)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5, BOT_LY + 7.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45, BOT_LY + 7.5), 1)
        pg.draw.line(self.screen, BLACK, (TOP_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45, TOP_LY), (BOT_LX + 48.5 + 45 + 45 + 48.5 + 45 + 45 + 48.5 + 45 + 45, BOT_LY + 7.5), 7)
    ...
    def find_cell(self, x, y):
        ...
        start_pos_x = TOP_LX + x * BLOCK_SIZE + x * 3.5
        print("cell: ", x, y)
        if x % 3 == 0:  # If thick line on the left
            ...
            for i in range(3):
                ...
                i += 1
            print("block: ", block)
            start_pos_x += block * 3.5

        else:
            start_pos_x = TOP_LX + x * BLOCK_SIZE + block * 3.5# + 1

        if (x + 1) % 3 == 0:    # If thick line on the right
            width = BLOCK_SIZE# - 3.5

        if y % 3 == 0:  # If thick line on the top
            start_pos_y = TOP_LY + y * BLOCK_SIZE + 3.5
            height = BLOCK_SIZE# - 4
        else:
        ...
        return (start_pos_x, start_pos_y, BLOCK_SIZE, BLOCK_SIZE)
