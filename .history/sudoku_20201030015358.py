...
class Display_board():
    ...
    def draw(self, grid):
        ...
        print("\ntop left corner pos: (", top_left_x, top_left_y, ")")
        print("top right corner: ", top_right_x, top_right_y, ")")
        print("bottom left corner: ", bottom_left_x, bottom_left_y, ")\n")

        pg.draw.line(self.screen, BLACK, ((SCREEN_WIDTH / 2), 
                                            (SCREEN_HEIGHT / 2) + i * self.dif), 
                                            (top_left_x, 
                                            top_left_y + i * self.dif), 1)
        pg.draw.line(self.screen, BLACK, ((SCREEN_WIDTH / 2), 
                                            (SCREEN_HEIGHT / 2) + i * self.dif), 
                                            (top_right_x, 
                                            top_right_y + i * self.dif), 1)
        pg.draw.line(self.screen, BLACK, ((SCREEN_WIDTH / 2), 
                                            (SCREEN_HEIGHT / 2) + i * self.dif), 
                                            (top_right_x, 
                                            top_right_y + i * self.dif), 1)
