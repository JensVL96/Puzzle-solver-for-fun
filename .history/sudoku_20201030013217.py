...
class Display_board():
    ...
    def draw(self, grid):
        start_pos = (SCREEN_WIDTH / 2) - (BORDER_SIZE / 2)
        end_pos = (SCREEN_WIDTH / 2) + (BORDER_SIZE / 2)
        for i in range (9):
            for j in range (9):
                if grid[i][j] != 0:
        ...
        for i in range(10):
            if i %3 == 0:
                ...
                thick = 1
            pg.draw.line(self.screen, BLACK, ((SCREEN_WIDTH / 2) - (BORDER_SIZE / 2), 
                                            (SCREEN_HEIGHT / 2) - (BORDER_SIZE / 2) + i * self.dif), 
                                            ((SCREEN_WIDTH / 2) + (BORDER_SIZE / 2), 
                                            (SCREEN_HEIGHT / 2) + (BORDER_SIZE / 2) + i * self.dif), thick)
